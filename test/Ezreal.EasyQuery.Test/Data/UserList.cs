...
namespace Ezreal.EasyQuery.Test.Data
{
    public class UserList : List<User>
    {
        public UserList()
        {
            Add(new User() { Name = "用户一",Age=12, Id = Guid.NewGuid(), CreateTime = DateTime.Now, Phone = "123-456-789", State = Enums.EnumUserState.Loss });
            ...
            Add(new User() { Name = "用户3", Age = 12, Id = Guid.NewGuid(), CreateTime = DateTime.Now.AddDays(1), Phone = "123-458-789", State = Enums.EnumUserState.Logout });
            ...
            Add(new User() { Name = "用户一", Age = 13, Id = Guid.NewGuid(), CreateTime = DateTime.Now, Phone = "123-456-789", State = Enums.EnumUserState.UnRegister });
